...
@property (nonatomic, assign, readwrite) NSInteger failTime;//超时次数
@property (nonatomic, assign, readwrite) NSInteger sucTime;//次数
@property (nonatomic, assign, readwrite) NSInteger maxTime;
@property (nonatomic, assign, readwrite) NSInteger minTime;
@property (nonatomic, assign, readwrite) NSInteger totalTime;
